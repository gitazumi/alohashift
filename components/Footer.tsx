        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          <div className="space-y-1">
            <p className="text-sm font-bold text-stone-800">
              Aloha<span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">Shift</span><span className="text-stone-400 font-light">.com</span>
            </p>
            <p className="text-xs text-stone-400">Built in Hawaii for Hawaii commuters.</p>
            <p className="text-xs text-stone-300">© {new Date().getFullYear()} AlohaShift. All rights reserved.</p>
          </div>
          <nav className="flex flex-wrap items-center gap-x-6 gap-y-2 text-sm text-stone-400 justify-start sm:justify-end">
