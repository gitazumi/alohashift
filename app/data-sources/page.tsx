      ...
      <div className="max-w-3xl mx-auto px-4 py-12 space-y-10">
        ...
        <div>
          ...
          <p className="text-slate-500 mt-2 leading-relaxed">
            ...
            the most accurate commute time estimates possible for Oahu's H1 corridor.
        ...
        <section className="bg-white rounded-2xl border border-slate-200 p-6 space-y-4">
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-3 text-sm text-amber-800">
            ...
            H1 freeway travel times during peak hours. Our real-world validation (6:53 AM departure,
            Kapolei → Honolulu: <strong>62 min actual</strong> vs <strong>30 min predicted</strong>)
            revealed a ~2× gap, which we correct with the Hawaii Reality Correction below.
          </div>
        ...
        {/* Section 2: Hawaii Reality Correction */}
        <section className="bg-white rounded-2xl border border-slate-200 p-6 space-y-4">
          <div className="flex items-start gap-4">
            <span className="text-2xl">🔬</span>
            <div>
              <h2 className="text-lg font-semibold text-slate-800">Hawaii H1 Reality Correction</h2>
          ...
          <p className="text-sm text-slate-600 leading-relaxed">
            Because Google Maps underestimates H1 congestion, we developed a time-of-day correction
            factor based on real commute measurements collected on Oahu. This is AlohaShift's
            original contribution — a Hawaii-specific layer on top of Google's predictions.
          </p>
            ...
            <table className="w-full text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-100">
                <tr className="bg-red-50">
                  ...
                  <td className="px-3 py-2 text-slate-600">AM peak — H1 severely congested</td>
                </tr>
                <tr>
          ...
          <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-3 text-sm text-emerald-800">
            ...
            (error: 1.2 min). Help us improve accuracy by{" "}
        ...
        <section className="bg-white rounded-2xl border border-slate-200 p-6 space-y-4">
          ...
          <p className="text-sm text-slate-600 leading-relaxed">
            ...
            the realistic number of H1 morning commuters shown in the Impact Simulator.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
            <div className="bg-slate-50 rounded-xl p-3">
            ...
            <div className="bg-slate-50 rounded-xl p-3">
              ...
              <p className="text-slate-700"><strong>~10,857</strong> H1 morning commuters (6–9 AM)</p>
            </div>
          </div>
        ...
        <section className="bg-white rounded-2xl border border-slate-200 p-6 space-y-4">
          ...
          <p className="text-sm text-slate-600 leading-relaxed">
            We use TomTom's Traffic Flow API to cross-check real-time H1 freeway speeds against
        ...
        <section className="bg-white rounded-2xl border border-slate-200 p-6 space-y-4">
          ...
          <p className="text-sm text-slate-600 leading-relaxed">
            ...
            and make AlohaShift more accurate for everyone. If you commute on H1 regularly,
            your data makes a real difference.
          </p>
          <Link
            href="/community"
